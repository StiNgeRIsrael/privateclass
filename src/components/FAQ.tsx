...
const FAQ: React.FC = () => {
  ...
  const faqs: FAQItem[] = [
    ...
    },
    {
      ...
      answer: "כן! אנחנו מציעים מבצע בהרצה: ברכישת חבילת 5 שיעורים, ניתן להתחרט אחרי השיעור הראשון ולשלם רק 160 ש" + String.fromCharCode(34) + "ח עבור השיעור שבוצע ולקבל זיכוי מלא על שארית הסכום. זו הזדמנות מצוינת להכיר את השיטה ולהתנסות בלמידה דרך משחק.",
      delay: 500,
    }
  ];
